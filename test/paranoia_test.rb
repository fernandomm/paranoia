...
class ParanoiaTest < test_framework
  ...
  def test_destroy_behavior_for_freshly_loaded_plain_models_callbacks
    ...
    assert model.instance_variable_get(:@after_destroy_callback_called)
    assert model.instance_variable_get(:@after_commit_callback_called)
    assert model.instance_variable_get(:@after_commit_on_destroy_callback_called)
  end
...
class CallbackModel < ActiveRecord::Base
  ...
  after_commit        Proc.new { |model| model.instance_variable_set :@after_commit_on_destroy_callback_called, true }, on: :destroy
